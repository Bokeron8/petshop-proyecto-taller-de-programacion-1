...
<div class="container mt-4 mb-5 p-4 rounded shadow-sm" style="background-color:rgb(238, 237, 237); border: 1px solid #e0e0e0;">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="dni" id="dni" class="form-control" placeholder="Ej: 12345678" value="<?= esc($usuario['dni_usuario'] ?? '') ?>" required min="1000000" max="99999999">
            ...
            <div class="mb-3">
                ...
                <input type="tel" name="telefono" id="telefono" class="form-control" placeholder="Ej: 3794123456" value="<?= esc($usuario['telefono_usuario'] ?? '') ?>" required>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="direccion" id="domicilio" class="form-control" placeholder="Calle, número, piso/depto (si aplica)" value="<?= esc($usuario['domicilio_usuario'] ?? '') ?>" required>
                <div class="invalid-feedback">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="forma_entrega" id="retiroLocal" value="0" required>
                    <label class="form-check-label" for="retiroLocal">Retiro en local</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="forma_entrega" id="envioDomicilio" value="1" required>
            ...
            <div class="form-check mb-2">
                ...
                <label class="form-check-label" for="termsCheck">Acepto los <a href="#" style="color: #007bff; text-decoration: none;">términos y condiciones</a></label>
                <div class="invalid-feedback">
    ...
    <div class="d-grid gap-2 col-md-6 mx-auto">
        <button type="submit" class="btn btn-primary btn-lg" style="background-color: #28a745; border-color: #28a745;">Confirmar Compra</button>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        checkoutForm.addEventListener('submit', function(event) {
            ...
            if (!dni.value || dni.value.length < 7 || dni.value.length > 8) { // Assuming DNI is 7 or 8 digits
